...
/**
 * From: startEvent: StartEvent_1, To: endEvent: Event_1imcxxd, Length: 4
 */
public class TC_11b_Gateway_XOR_false extends AbstractJUnit4TestCase {
  ...
  protected void execute(ProcessInstance pi) {
    ...
    // endEvent: Event_1imcxxd
    assertThat(pi).hasPassed("Event_1imcxxd");
  }
